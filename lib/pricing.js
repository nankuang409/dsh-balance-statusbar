...
export const OFFICIAL_PRICING_POLICIES = [
  ...
  {
    // 人民币单价照抄官方价格表（api-docs.deepseek.com/zh-cn/quick_start/pricing）。
    // Pro 未变；Flash 全面降价。旧 id 按官方脚注「请求由 V4.1-Flash 提供服务并按
    // Flash 价格计费」一并指向新价。
    // cny 抄中文页、usd 抄英文页（api-docs.deepseek.com/quick_start/pricing），
    // 均为官方数字。唯一待核：官方未标生效日，此处取 V4.1-Flash 转正日。
    since: "2026-09-10T00:00:00+08:00",
    label: "DeepSeek-V4.1-Flash 转正：Flash 降价，旧 flash id 归并到 Flash 价（Pro 不变）",
    peak: {
      "deepseek-flash": {
...
export function isPeak(timeMs, timezone = DEFAULT_TIMEZONE, windows = DEFAULT_PEAK_WINDOWS) {
  ...
  // 官方口径是「北京时间周一至周五 9:00-12:00、14:00-18:00」，周末全天空闲价。
